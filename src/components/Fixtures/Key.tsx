export default function Key() {
    return (
        <div className='relative w-[220px] h-[32px] lg:h-[50px]'>
            <div className='absolute right-0 w-full h-full lg:h-3/5 grid grid-cols-5 font-bold gap-[1px] pb-[1px]'>
            ...
            <span className='absolute left-[-40px] bottom-1 lg:left-0 lg:bottom-0 font-[500]'>Easy</span>
            <span className='absolute right-[-62px] bottom-1 lg:right-0 lg:bottom-0 font-[500]'>Difficult</span>
        </div>
    )
}